...
document.querySelector('#solid').innerHTML = `
  <main class="h-full w-full">
      <div class="max-w-6xl mx-auto p-5">
          <!-- Title Slide -->
          <div class="bg-white rounded-2xl shadow-2xl mb-8 p-12 text-center ${hoverEffect}">
              <h1 class="text-5xl md:text-6xl font-bold text-gray-900 mb-6">SOLID Principles</h1>
              <p class="text-xl md:text-2xl text-gray-600 mb-4">Building Better Software Through Better Design</p>
              <p class="text-lg text-gray-500">A Developer's Guide to Object-Oriented Design</p>
          </div>

          <!-- Introduction -->
          <div class="bg-white rounded-2xl shadow-xl mb-8 p-8 ${hoverEffect}">
              ...
              <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-8 rounded-xl">
          ...
          <div class="bg-white rounded-2xl shadow-xl mb-8 p-8 ${hoverEffect}">
              <div class="flex items-center mb-8">
                  <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-3xl font-bold mr-6 shadow-lg">S</div>
                  <div>
              ...
              <div class="bg-red-50 border-l-4 border-red-500 p-6 mb-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>class User {
      private name: string;
  ...
  class EmailService {
      sendEmail(email: string, message: string): void {
          ...
          <div class="bg-white rounded-2xl shadow-xl mb-8 p-8 ${hoverEffect}">
              <div class="flex items-center mb-8">
                  <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-3xl font-bold mr-6 shadow-lg">O</div>
                  <div>
              ...
              <div class="bg-red-50 border-l-4 border-red-500 p-6 mb-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>class PaymentProcessor {
      processPayment(amount: number, type: string): void {
          if (type === 'credit') {
              ...
              <div class="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>interface PaymentMethod {
  ...
  class PaymentProcessor {
      processPayment(amount: number, paymentMethod: PaymentMethod): void {
          ...
          <div class="bg-white rounded-2xl shadow-xl mb-8 p-8 ${hoverEffect}">
              <div class="flex items-center mb-8">
                  <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-3xl font-bold mr-6 shadow-lg">L</div>
                  <div>
              ...
              <div class="bg-red-50 border-l-4 border-red-500 p-6 mb-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>class Bird {
      fly(): void {
          console.log("Flying...");
      }
  }
  ...
  function makeBirdFly(bird: Bird): void {
      bird.fly(); // Will throw error for Penguin
              ...
              <div class="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>abstract class Bird {
      abstract move(): void;
  }
  ...
  function makeBirdMove(bird: Bird): void {
      bird.move(); // Works for all birds
          ...
          <div class="bg-white rounded-2xl shadow-xl mb-8 p-8 ${hoverEffect}">
              <div class="flex items-center mb-8">
                  <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-3xl font-bold mr-6 shadow-lg">I</div>
                  <div>
              ...
              <div class="bg-red-50 border-l-4 border-red-500 p-6 mb-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>interface Worker {
      work(): void;
      eat(): void;
      sleep(): void;
  }
      ...
      sleep(): void { 
          throw new Error("Robots don't sleep!"); // Forced to implement unused method
              ...
              <div class="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>interface Workable {
      work(): void;
  }
  ...
  class WorkManager {
      manage(worker: Workable): void {
          ...
          <div class="bg-white rounded-2xl shadow-xl mb-8 p-8 ${hoverEffect}">
              <div class="flex items-center mb-8">
                  <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-3xl font-bold mr-6 shadow-lg">D</div>
                  <div>
              ...
              <div class="bg-red-50 border-l-4 border-red-500 p-6 mb-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>class MySQLDatabase {
      ...
      createUser(userData: string): void {
          ...
          this.database.save(userData);
              ...
              <div class="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg">
                  ...
                  <pre class="${codeSnippet}"><code>interface Database {
      save(data: string): void;
  }
